...
function Template() {
  return (
    <Box>
      ...
      <Flex gap={1}>
        {/* ONe  */}
        <Box position={"fixed"} zIndex={1} mt={"120px"} w={"22%"} h={"580px"}>
          <Flex m={2}>
          ...
          {/* Second  */}
          <Box overflowY={"scroll"} ml={2} mr={2} mt={5}>
            <Text
              mb={5}
              ml={2}
              textAlign={"left"}
            ...
            <Flex flexDirection={"column"} gap={2} m={2}>
              <HashLink smooth to="#Content_production">
                <Text
                  cursor={"pointer"}
                  _hover={{ color: "gray.700", transition: ".3s" }}
                  textAlign={"left"}
                  fontSize={"15px"}
                  color={"gray.400"}
                  fontWeight={400}
              ...
              <HashLink smooth to="#Event_planning">
              ...
              <HashLink smooth to="#Project_management">
              <Text
                textAlign={"left"}
                fontSize={"15px"}
                color={"gray.400"}
            ...
            <SimpleGrid p={4} gap={5} columns={[1, 2, 3]}>
              <Box borderRadius={"10px"} border={1} boxShadow={"lg"}>
                ...
                <Text
                  ...
                  color={"gray.400"}
                >
                  Video production can seem daunting at first, but the key to
                  any complicated, collaborative project is organization...
                </Text>
              </Box>
              <Box borderRadius={"10px"} border={1} boxShadow={"lg"}>
                <Image
                ...
                <Text
                  ...
                  color={"gray.400"}
                >
                  World-class social media teams move fast. Part content
                  calendar, part culture calendar, this social template helps
                  yo...
                </Text>
              </Box>
              <Box borderRadius={"10px"} border={1} boxShadow={"lg"}>
          ...
          <SimpleGrid p={4} gap={5} columns={[1, 2, 3]}>
            <Box borderRadius={"10px"} border={1} boxShadow={"lg"}>
              ...
              <Text
                ...
                color={"gray.400"}
              >
                Manage every step from script to screen! You can use this
                template to plan out scenes, shots, props and acto...
              </Text>
            </Box>
            <Box borderRadius={"10px"} border={1} boxShadow={"lg"}>
              <Image
          ...
          <SimpleGrid p={4} gap={5} columns={[1, 2, 3]}>
            ...
            <Box borderRadius={"10px"} border={1} boxShadow={"lg"}>
              ...
              <Text
                ...
                color={"gray.400"}
              >
                Venues, schedules, speakers—there's a lot that goes in to
                pulling off a successful event. This template will hel...
              </Text>
            </Box>
          </SimpleGrid>
          </Box>
          ...
          <SimpleGrid p={4} gap={5} columns={[1, 2, 3]}>
            <Box borderRadius={"10px"} border={1} boxShadow={"lg"}>
              ...
              >
                ...
                reservations. List the restaurants you'd like to visit, and
                jot...
              </Text>
            </Box>
            <Box borderRadius={"10px"} border={1} boxShadow={"lg"}>
              ...
              <Text
                ...
                color={"gray.400"}
              >
                Whether you identify as a cat person, or a dog person, or a
                guinea pig or snake person, remembering vet visits,...
              </Text>
            </Box>
            <Box borderRadius={"10px"} border={1} boxShadow={"lg"}>
              <Image
              ...
              <Text
                ...
                color={"gray.400"}
              >
                Apartment hunting is stressful, with so many budgets, details,
                and and amenities to track. Parking or no...
              </Text>
            </Box>
          </SimpleGrid>
          </Box>
          ...
          <SimpleGrid p={4} gap={5} columns={[1, 2, 3]}>
            <Box borderRadius={"10px"} border={1} boxShadow={"lg"}>
              ...
              <Text
                ...
                color={"gray.400"}
              >
                Are you a bookworm who can never quite remember the title of
                that next book ou were going to read? Do you...
              </Text>
            </Box>
            <Box borderRadius={"10px"} border={1} boxShadow={"lg"}>
              <Image
          ...
          <SimpleGrid p={4} gap={5} columns={[1, 2, 3]}>
            <Box borderRadius={"10px"} border={1} boxShadow={"lg"}>
              ...
              <Text
                ...
                color={"gray.400"}
              >
                A dozen candidates apply for a job. Each is in different steps
                of the process. And each requires dedicated emails,...
              </Text>
            </Box>
            <Box borderRadius={"10px"} border={1} boxShadow={"lg"}>
              <Image
            ...
            <Box borderRadius={"10px"} border={1} boxShadow={"lg"}>
              ...
              <Text
                ...
                color={"gray.400"}
              >
                Airtable is a simple and fast way to keep track of your
                employees' hours worked across different projects. Easily
                update...
              </Text>
            </Box>
          </SimpleGrid>
          ...
          <SimpleGrid p={4} gap={5} columns={[1, 2, 3]}>
            ...
            <Box borderRadius={"10px"} border={1} boxShadow={"lg"}>
              ...
              <Text
                ...
                color={"gray.400"}
              >
                Why buy the cow? Because milk isn't free. Track profits,
                livestock and more with this easy and extensible cattle...
              </Text>
            </Box>
            <Box borderRadius={"10px"} border={1} boxShadow={"lg"}>
              <Image
          ...
          <SimpleGrid p={4} gap={5} columns={[1, 2, 3]}>
            ...
            <Box borderRadius={"10px"} border={1} boxShadow={"lg"}>
              ...
              <Text
                ...
                color={"gray.400"}
              >
                Marketing campaigns are complex—and between all the click
                tracking and conversions, they can get messy. If...
              </Text>
            </Box>
            <Box borderRadius={"10px"} border={1} boxShadow={"lg"}>
              <Image
          ...
          <SimpleGrid p={4} gap={5} columns={[1, 2, 3]}>
            ...
            <Box borderRadius={"10px"} border={1} boxShadow={"lg"}>
              ...
              <Text
                ...
                color={"gray.400"}
              >
                Most CRM products make a few too many assumptions about how a
                CRM should work for you. We don't pretend...
              </Text>
            </Box>
            <Box borderRadius={"10px"} border={1} boxShadow={"lg"}>
              <Image
          ...
          <SimpleGrid p={4} gap={5} columns={[1, 2, 3]}>
            <Box borderRadius={"10px"} border={1} boxShadow={"lg"}>
              ...
              <Text
                ...
                color={"gray.400"}
              >
                Meant for an internal PR or comms team, this template can be
                used to track press for competitors and journalist...
              </Text>
            </Box>
            <Box borderRadius={"10px"} border={1} boxShadow={"lg"}>
              <Image
              ...
              <Text
                ...
                color={"gray.400"}
              >
                Keeping your product message consistent is a challenge,
                especially when you manage a team where...
              </Text>
            </Box>
            <Box borderRadius={"10px"} border={1} boxShadow={"lg"}>
              <Image
              ...
              <Text
                ...
                color={"gray.400"}
              >
                Stop the presses! Track your journalist contacts and
                competitors' press mentions with this template.
              </Text>
            </Box>
          </SimpleGrid>
          </Box>
          ...
          <SimpleGrid p={4} gap={5} columns={[1, 2, 3]}>
            ...
            <Box borderRadius={"10px"} border={1} boxShadow={"lg"}>
              ...
              <Text
                ...
                color={"gray.400"}
              >
                Customer stories? Sprints? Epics? If hearing those words gets
                you excited for rapid product development, then...
              </Text>
            </Box>
          </SimpleGrid>
          </Box>
          {/* Project Management  */}
          <Box id="Project_management">
          <Flex p={5}>
            <Text fontSize={"25px"} color={"gray.400"} fontWeight={500}>
              Project Management
            </Text>
          ...
          <SimpleGrid p={4} gap={5} columns={[1, 2, 3]}>
            <Box borderRadius={"10px"} border={1} boxShadow={"lg"}>
              ...
              <Text
                ...
                color={"gray.400"}
              >
                Impending deadlines. Critical collaborators. Tiny tasks. They
                all make up a small—but essential—part of...
              </Text>
            </Box>
            <Box borderRadius={"10px"} border={1} boxShadow={"lg"}>
              <Image
